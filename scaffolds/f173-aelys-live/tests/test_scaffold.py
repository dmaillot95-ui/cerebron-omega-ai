...
class TestF173(unittest.TestCase):
    def test_project(self):
        ...
        self.assertEqual(p["status"],"LOCAL_LIVE_LOOP_TTS_SESSION_REPLAY_CANARIES_PASS_EXTERNAL_RUNTIME_UNQUALIFIED")
        self.assertTrue(p["target_repo_initialized"])
        self.assertEqual(p["dedicated_repo_selftest_run_id"],36163651569)
